...
#print pull(['s1'])
push(["s1"] + ["1234"] + ["metadata=1234,in_port=1,nw_src=10.10.10.10"])
push(["s1"] + ["1222"] + ["metadata=1134,in_port=2,nw_src=10.10.10.10"])
push(["s1"] + ["1254"] + ["metadata=1434,in_port=1,nw_src=10.10.10.10"])
push(["s1"] + ["1252"] + ["metadata=1434,in_port=2,nw_src=10.10.10.10"])
t1 = time.time()
remove(['s1'] + ['1222'])
t2 = time.time()
print t2 - t1